...
type Props = NativeStackScreenProps<TestAppRootStackParamList, 'Home'>;
...
const HomeScreen = ({navigation}: Props) => {
  ...
  const onPressGoToBaroMeterPage = () => {
    navigation.navigate('BaroMeter', {
      screen: 'Calendar',
    });
  };
  ...
  return (
    <>
      ...
      <SafeAreaView style={styles.root}>
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={onPressGoToBaroMeterPage}>
          <Text>barometer 페이지 이동</Text>
        </TouchableOpacity>
