  ...
  return (
    <div className="wrap">
      ...
      <main className="main calendar weekly-view">
        <Header headerType="basic" titleText="THIS WEEK" />
        <div className="contents">
          <div className="calendar-area">
            ...
            <WeeklyCalendarView
              ...
              activeDate={5}
              dateData={[
                { date: 1, score: 1, successGoalCount: 1 }, // 나쁨(bad)
                { date: 2, score: 3, successGoalCount: 2 }, // 좋지않음(notgood)
                { date: 3, score: 3, successGoalCount: 3 }, // 좋음(good)
                { date: 4, score: 4, successGoalCount: 4 }, // 매우좋음(nice)
                { date: 5, score: 0, successGoalCount: 5 }, // 기본 상태 (선택됨)
